...
import com.example.googlelensapp.DataModal;
import com.example.googlelensapp.SearchResultsRVAdapter;
...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        super.onStart();
        manager = new LinearLayoutManager(SecondActivity.this, LinearLayoutManager.HORIZONTAL, false);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resultRV = (RecyclerView) findViewById(R.id.idRVSearchResults);

        Log.d("check", "resultRV: "+resultRV);
        Log.d("check", "manager: "+manager);
        // initializing our array list
        dataModalArrayList = new ArrayList<>();

        // initializing our adapter class.
        searchResultsRVAdapter = new SearchResultsRVAdapter(dataModalArrayList, SecondActivity.this);
    ...
    private void getResults() {
        ...
        Log.d("image", "String image: "+image.toString());
        ...
        Log.d("image label", "label image: "+labeler.toString());
        ...
        labeler.processImage(image).addOnSuccessListener(new OnSuccessListener<List<FirebaseVisionImageLabel>>() {
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(SecondActivity.this, "Fail to detect image..", Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void searchData(String searchQuery) {
        String apiKey = "dae4f3572c9923e2dbb7972a062e491a8b4c155e68f7cee42a20b6ce94ebbe20";
        String url = "https://serpapi.com/search.json?q=" + searchQuery.trim() + "&location=Bangalore,India&hl=en&gl=us&google_domain=google.com&api_key=" + apiKey;
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onErrorResponse(VolleyError error) {
                // displaying error message.
                Toast.makeText(SecondActivity.this, "No Result found for the search query..", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
            ...
            Log.d("Image","bitmap: "+imageBitmap);
        }
    }
}
